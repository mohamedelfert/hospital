                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <select name="gender" id="gender" class="form-control" required>
                                        ...
                                        <option
                                            value="male" {{ $reservation->gender === 'male' ? 'selected':'' }}>{{ trans('main.male') }}</option>
                                        <option
                                            value="female" {{ $reservation->gender === 'female' ? 'selected':'' }}>{{ trans('main.female') }}</option>
                                    </select>
                                </div>
                                <div class="col">
                                    <label for="age">{{ trans('main.age') }}</label>
                                    <input type="number" class="form-control" min="0" max="120" step="0.1" id="age"
                                           name="age" value="{{ $reservation->age}}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <textarea class="form-control" id="address" name="address"
                                              rows="3">{{ $reservation->address }}</textarea>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    ...
                                    <select name="examination_id" id="examination" class="form-control" required>
                                        ...
                                        @foreach($examinations as $examination)
                                            <option
                                                value="{{ $examination->id }}" {{ $reservation->examination_id === $examination->id ? 'selected':'' }}>{{ $examination->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col">
                                    ...
                                    <select name="specialty_id" id="specialty" class="form-control" required>
                                        ...
                                        @foreach($specialties as $specialty)
                                            <option
                                                value="{{ $specialty->id }}" {{ $reservation->specialty_id === $specialty->id ? 'selected':'' }}>{{ $specialty->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col">
                                    ...
                                    <select name="doctor_id" id="doctor" class="form-control" required>
                                        <option
                                            value="{{ $reservation->doctor->id  }}" {{ $reservation->doctor_id === $reservation->doctor->id ? 'selected':'' }}>{{ $reservation->doctor->name }}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <select name="day_id" id="day" class="form-control" required>
                                        <option
                                            value="{{ $reservation->day->id }}" {{ $reservation->day_id === $reservation->day->id ? 'selected':'' }}>{{ $reservation->day->day }}</option>
                                    </select>
                                </div>
                                <div class="col">
                                    <label for="date">{{ trans('main.date') }}</label>
                                    <input class="form-control fc-datepicker" type="date" id="date" name="date"
